...
-- add_material_node_plugin("BSDF", "MatteBSDF")
-- add_material_node_plugin("BSDF", "MirrorBSDF")
-- add_material_node_plugin("BSDF", "PlasticBSDF")
-- add_material_node_plugin("BSDF", "BlendBSDF")
add_material_node_plugin("BSDF", "DiffuseBSDF")
-- add_material_node_plugin("BSDF", "SubstrateBSDF")
add_material_node_plugin("BSDF", "DielectricBSDF")
add_material_node_plugin("BSDF", "ConductorBSDF")
add_material_node_plugin("BSDF", "ThinDielectricBSDF")
add_material_node_plugin("BSDF", "PlasticBSDF")
add_material_node_plugin("BSDF", "MixBSDF")
