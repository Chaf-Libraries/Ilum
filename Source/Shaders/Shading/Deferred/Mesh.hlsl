...
[numthreads(32, 1, 1)] void ASmain(CSParam param) {
    ...
    [numthreads(32, 1, 1)] void MSmain(CSParam param, in payload Payload pay_load, out vertices VertexOut verts[64], out indices uint3 tris[126])
{
...
#	ifdef USE_JITTER
		clipPos += float4(camera.jitter * clipPos.w, 0, 0);
#	endif
