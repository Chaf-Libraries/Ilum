...
namespace NAMESPACE_5897945802466814315
{
RTTR_REGISTRATION
{
...
rttr::registration::class_<Ilum::StaticMeshComponent>("Ilum::StaticMeshComponent")
	...
	.property("submeshes", &Ilum::StaticMeshComponent::submeshes)
	.constructor<>()(rttr::policy::ctor::as_object);
...
SERIALIZER_REGISTER_TYPE(decltype(Ilum::StaticMeshComponent::submeshes))
