...
namespace NAMESPACE_17245465098198044462
{
RTTR_REGISTRATION
{
using namespace Ilum;

rttr::registration::class_<Ilum::RHIAcceleration>("Ilum::RHIAcceleration");
...
rttr::registration::class_<Ilum::BufferStateTransition>("Ilum::BufferStateTransition")
	.property("buffer", &Ilum::BufferStateTransition::buffer)
	.property("src", &Ilum::BufferStateTransition::src)
	.property("dst", &Ilum::BufferStateTransition::dst);
...
rttr::registration::class_<Ilum::RHIDescriptor>("Ilum::RHIDescriptor")
	.method("GetShaderMeta", &Ilum::RHIDescriptor::GetShaderMeta)
	.constructor(&Ilum::RHIDescriptor::Create)(rttr::metadata("constructor", true))
	.method("BindTexture",  static_cast<RHIDescriptor & (Ilum::RHIDescriptor::*)(const std::string&, RHITexture*, RHITextureDimension)>(&Ilum::RHIDescriptor::BindTexture))
	.method("BindTexture",  static_cast<RHIDescriptor & (Ilum::RHIDescriptor::*)(const std::string&, RHITexture*, const TextureRange&)>(&Ilum::RHIDescriptor::BindTexture))
	.method("BindTexture",  static_cast<RHIDescriptor & (Ilum::RHIDescriptor::*)(const std::string&, const std::vector<RHITexture *>&, RHITextureDimension)>(&Ilum::RHIDescriptor::BindTexture))
	.method("BindSampler",  static_cast<RHIDescriptor & (Ilum::RHIDescriptor::*)(const std::string&, RHISampler*)>(&Ilum::RHIDescriptor::BindSampler))
	.method("BindSampler",  static_cast<RHIDescriptor & (Ilum::RHIDescriptor::*)(const std::string&, const std::vector<RHISampler *>&)>(&Ilum::RHIDescriptor::BindSampler))
	.method("BindBuffer",  static_cast<RHIDescriptor & (Ilum::RHIDescriptor::*)(const std::string&, RHIBuffer*)>(&Ilum::RHIDescriptor::BindBuffer))
	.method("BindBuffer",  static_cast<RHIDescriptor & (Ilum::RHIDescriptor::*)(const std::string&, RHIBuffer*, size_t, size_t)>(&Ilum::RHIDescriptor::BindBuffer))
	.method("BindBuffer",  static_cast<RHIDescriptor & (Ilum::RHIDescriptor::*)(const std::string&, const std::vector<RHIBuffer *>&)>(&Ilum::RHIDescriptor::BindBuffer))
	.method("BindConstant", &Ilum::RHIDescriptor::BindConstant);
...
rttr::registration::class_<Ilum::RHISampler>("Ilum::RHISampler")
	.constructor<RHIDevice*, const SamplerDesc&>()
	.method("Create", &Ilum::RHISampler::Create);
...
rttr::registration::class_<Ilum::RHIShader>("Ilum::RHIShader")
	.constructor<RHIDevice*, const std::string&, const std::vector<uint8_t>&>()
	.method("Create", &Ilum::RHIShader::Create)
	.method("GetEntryPoint", &Ilum::RHIShader::GetEntryPoint);

rttr::registration::class_<Ilum::RHISemaphore>("Ilum::RHISemaphore")
	.constructor<RHIDevice*>()
	.method("Create", &Ilum::RHISemaphore::Create);
...
rttr::registration::class_<Ilum::TextureRange>("Ilum::TextureRange")
	...
	.property("base_mip", &Ilum::TextureRange::base_mip)
	.property("mip_count", &Ilum::TextureRange::mip_count)
	.property("base_layer", &Ilum::TextureRange::base_layer)
	.property("layer_count", &Ilum::TextureRange::layer_count)
	.method("Hash", &Ilum::TextureRange::Hash);

rttr::registration::class_<Ilum::RHITexture>("Ilum::RHITexture")
	.constructor<RHIDevice*, const TextureDesc&>()
	.method("GetDesc", &Ilum::RHITexture::GetDesc)
	.method("Alias", &Ilum::RHITexture::Alias)
	.method("Create", &Ilum::RHITexture::Create)
	.method("Create2D", &Ilum::RHITexture::Create2D)
	.method("Create3D", &Ilum::RHITexture::Create3D)
	.method("CreateCube", &Ilum::RHITexture::CreateCube)
	.method("Create2DArray", &Ilum::RHITexture::Create2DArray);

rttr::registration::class_<Ilum::TextureStateTransition>("Ilum::TextureStateTransition")
	.property("texture", &Ilum::TextureStateTransition::texture)
	.property("src", &Ilum::TextureStateTransition::src)
	.property("dst", &Ilum::TextureStateTransition::dst)
	.property("range", &Ilum::TextureStateTransition::range);
...
void serialize(Archive& archive, Ilum::RHIAcceleration& v)
{
	archive();
}
...
template <class Archive>
void serialize(Archive& archive, Ilum::RHIBuffer& v)
{
	archive();
}

template <class Archive>
void serialize(Archive& archive, Ilum::BufferStateTransition& v)
{
	archive(v.buffer, v.src, v.dst);
}

template <class Archive>
void serialize(Archive& archive, Ilum::RHICommand& v)
{
	archive();
}

template <class Archive>
void serialize(Archive& archive, Ilum::RHIContext& v)
{
	archive();
}

template <class Archive>
void serialize(Archive& archive, Ilum::RHIDescriptor& v)
{
	archive();
}

template <class Archive>
void serialize(Archive& archive, Ilum::RHIDevice& v)
{
	archive();
}

template <class Archive>
void serialize(Archive& archive, Ilum::RHIFrame& v)
{
	archive();
}
...
template <class Archive>
void serialize(Archive& archive, Ilum::RHIQueue& v)
{
	archive();
}
...
template <class Archive>
void serialize(Archive& archive, Ilum::RHIRenderTarget& v)
{
	archive();
}
...
template <class Archive>
void serialize(Archive& archive, Ilum::RHISampler& v)
{
	archive();
}
...
template <class Archive>
void serialize(Archive& archive, Ilum::RHIShader& v)
{
	archive();
}

template <class Archive>
void serialize(Archive& archive, Ilum::RHISwapchain& v)
{
	archive();
}

template <class Archive>
void serialize(Archive& archive, Ilum::RHIFence& v)
{
	archive();
}

template <class Archive>
void serialize(Archive& archive, Ilum::RHISemaphore& v)
{
	archive();
}
...
{
	archive(v.name, v.width, v.height, v.depth, v.mips, v.layers, v.samples, v.format, v.usage);
}
...
template <class Archive>
void serialize(Archive& archive, Ilum::RHITexture& v)
{
	archive();
}

template <class Archive>
void serialize(Archive& archive, Ilum::TextureStateTransition& v)
{
	archive(v.texture, v.src, v.dst, v.range);
}
