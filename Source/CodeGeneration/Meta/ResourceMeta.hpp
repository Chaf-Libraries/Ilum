...
namespace NAMESPACE_11799813201949700914
{
RTTR_REGISTRATION
{
...
rttr::registration::class_<Ilum::Meshlet::Bound>("Ilum::Meshlet::Bound")
	...
	.property("cone_apex", &Ilum::Meshlet::Bound::cone_apex)
...
rttr::registration::class_<Ilum::Meshlet>("Ilum::Meshlet")
	...
	.property("meshlet_indices_offset", &Ilum::Meshlet::meshlet_indices_offset)
	.constructor<>()(rttr::policy::ctor::as_object);
...
SERIALIZER_REGISTER_TYPE(decltype(Ilum::Meshlet::Bound::cone_apex))
...
SERIALIZER_REGISTER_TYPE(decltype(Ilum::Meshlet::meshlet_indices_offset))
...
{
	archive(v.center, v.radius, v.cone_axis, v.cone_cutoff, v.cone_apex);
}

template <class Archive>
void serialize(Archive& archive, Ilum::Meshlet& v)
{
	archive(v.bound, v.indices_offset, v.indices_count, v.vertices_offset, v.vertices_count, v.meshlet_vertices_offset, v.meshlet_indices_offset);
}
