...
namespace NAMESPACE_15793363766670778109
{
RTTR_REGISTRATION
{
...
rttr::registration::class_<Ilum::ReblurTemporalAccumulation::Config>("Ilum::ReblurTemporalAccumulation::Config")
	.property("a", &Ilum::ReblurTemporalAccumulation::Config::a)
	.constructor<>()(rttr::policy::ctor::as_object);
...
SERIALIZER_REGISTER_TYPE(decltype(Ilum::ReblurTemporalAccumulation::Config::a))
SERIALIZER_REGISTER_TYPE(Ilum::ReblurTemporalAccumulation::Config)
...
template <class Archive>
void serialize(Archive& archive, Ilum::ReblurTemporalAccumulation::Config& v)
{
	archive(v.a);
}
