...
namespace NAMESPACE_4852086221413003519
{
RTTR_REGISTRATION
{
...
rttr::registration::class_<Ilum::DebugPass>("Ilum::DebugPass")(rttr::metadata("RenderPass", "Debug Pass"))
	.method("CreateDesc", &Ilum::DebugPass::CreateDesc)
	.method("Create", &Ilum::DebugPass::Create)
	.constructor<>()(rttr::policy::ctor::as_object);

rttr::registration::class_<Ilum::PresentPass>("Ilum::PresentPass")(rttr::metadata("RenderPass", "Present Pass"))
	.method("CreateDesc", &Ilum::PresentPass::CreateDesc)
	.method("Create", &Ilum::PresentPass::Create)
	.constructor<>()(rttr::policy::ctor::as_object);

rttr::registration::class_<Ilum::TrianglePass>("Ilum::TrianglePass")(rttr::metadata("RenderPass", "Triangle Pass"))
