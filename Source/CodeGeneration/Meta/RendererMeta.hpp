...
namespace NAMESPACE_15876286198520867902
{
RTTR_REGISTRATION
{
...
rttr::registration::class_<Ilum::ReblurBlur>("Ilum::ReblurBlur")(rttr::metadata("RenderPass", "Reblur Blur"), rttr::metadata("Category", "Nvidia Ray Tracing Denoisor"))
...
rttr::registration::class_<Ilum::PostReblurBlur>("Ilum::PostReblurBlur")(rttr::metadata("RenderPass", "Reblur Post Blur"), rttr::metadata("Category", "Nvidia Ray Tracing Denoisor"))
...
SERIALIZER_REGISTER_TYPE(Ilum::ReblurBlur)
SERIALIZER_REGISTER_TYPE(Ilum::ReblurHistoryFix)
SERIALIZER_REGISTER_TYPE(Ilum::PostReblurBlur)
...
template <class Archive>
void serialize(Archive& archive, Ilum::ReblurBlur& v)
{
}
...
template <class Archive>
void serialize(Archive& archive, Ilum::PostReblurBlur& v)
{
}
