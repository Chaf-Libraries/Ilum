...
{
template <>
struct hash<Ilum::Vulkan::ReflectionData::InputAttachment>
{
	size_t operator()(const Ilum::Vulkan::ReflectionData::InputAttachment &input_attachment) const
	{
		size_t seed = 0;
...
template <>
struct hash<Ilum::Vulkan::ReflectionData::Image>
{
	size_t operator()(const Ilum::Vulkan::ReflectionData::Image &image) const
	{
		size_t seed = 0;
...
template <>
struct hash<Ilum::Vulkan::ReflectionData::Buffer>
{
	size_t operator()(const Ilum::Vulkan::ReflectionData::Buffer &buffer) const
	{
		size_t seed = 0;
