...
namespace Ilum
{
ShaderBindingTableInfo::ShaderBindingTableInfo(RHIDevice *device, uint32_t handle_count) :
...
ShaderBindingTableInfo::~ShaderBindingTableInfo()
{
...
uint8_t *ShaderBindingTableInfo::GetData()
{
