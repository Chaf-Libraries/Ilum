...
struct RenderBuffer
{
	...
	//// Draw count buffer:
	//Buffer Count_BufferBuffer = Buffer(sizeof(MeshCountData), VK_BUFFER_USAGE_STORAGE_BUFFER_BIT | VK_BUFFER_USAGE_INDIRECT_BUFFER_BIT, VMA_MEMORY_USAGE_GPU_TO_CPU);
	...
	LightCountData light_count;

	MeshCountData mesh_count;
};
}        // namespace Ilum