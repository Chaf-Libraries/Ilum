...
void BrightPass::setupPipeline(PipelineState &state)
{
	...
	state.declareAttachment("bright", VK_FORMAT_R32G32B32A32_SFLOAT, Renderer::instance()->getRenderTargetExtent().width, Renderer::instance()->getRenderTargetExtent().height);
