...
void CopyPass::render(RenderPassState &state)
{
	...
	cmd_buffer.CopyImage(
	    Graphics::ImageInfo{state.graph.getAttachment("gbuffer - linear_depth"), VK_IMAGE_USAGE_TRANSFER_SRC_BIT},
	    Graphics::ImageInfo{*Renderer::instance()->Last_Frame.depth_buffer, VK_IMAGE_USAGE_SAMPLED_BIT});
	...
	cmd_buffer.CopyImage(
	    Graphics::ImageInfo{state.graph.getAttachment("taa_result"), VK_IMAGE_USAGE_TRANSFER_SRC_BIT},
	    Graphics::ImageInfo{*Renderer::instance()->Last_Frame.last_result, VK_IMAGE_USAGE_SAMPLED_BIT});
