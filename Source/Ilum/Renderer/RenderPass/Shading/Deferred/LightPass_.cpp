...
namespace Ilum::pass
{
LightPass_::LightPass_(bool luma) :
    m_luma(luma)
{
...
void LightPass_::setupPipeline(PipelineState &state)
{
	...
	state.shader.load(std::string(PROJECT_SOURCE_DIR) + "Source/Shaders/Shading/Deferred/Lighting.hlsl", VK_SHADER_STAGE_COMPUTE_BIT, Shader::Type::HLSL, "main", macros);
...
void LightPass_::resolveResources(ResolveState &resolve)
{
...
void LightPass_::render(RenderPassState &state)
{
