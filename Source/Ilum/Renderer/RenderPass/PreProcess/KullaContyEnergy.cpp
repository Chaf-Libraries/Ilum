...
KullaContyEnergy::KullaContyEnergy():
    m_kulla_conty_energy{Graphics::RenderContext::GetDevice()}
{
	m_kulla_conty_energy = Graphics::Image(Graphics::RenderContext::GetDevice(), 128, 128, VK_FORMAT_R16_SFLOAT, VK_IMAGE_USAGE_STORAGE_BIT | VK_IMAGE_USAGE_SAMPLED_BIT, VMA_MEMORY_USAGE_GPU_ONLY);
