...
void InstanceCullingPass::setupPipeline(PipelineState &state)
{
	...
	state.descriptor_bindings.bind(0, 3, "hiz - buffer", Renderer::instance()->getSampler(Renderer::SamplerType::Point_Clamp), Graphics::ImageViewType::Native, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER);
