...
class ShaderCache
{
  public:
	...
	VkShaderModule load(const std::string &filename, VkShaderStageFlagBits stage, Shader::Type type = Shader::Type::GLSL, const std::string &entry_point = "main", const std::vector<std::string> &macros = {});
